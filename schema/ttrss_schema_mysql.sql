...
insert into ttrss_prefs (pref_name,type_id,value,def_value,short_desc,section_id) values('ENABLE_LABELS', 1, 'false', 'false', 'Enable experimental support for labels',1);
...
insert into ttrss_prefs (pref_name,type_id,value,def_value,short_desc,section_id) values('DEFAULT_ARTICLE_LIMIT', 3, '0', '0', 'Default article limit',2);
insert into ttrss_prefs (pref_name,type_id,value,def_value,short_desc,section_id) values('DAEMON_REFRESH_ONLY', 1, 'false', 'false', 'Daemon refresh only',1);
insert into ttrss_prefs (pref_name,type_id,value,def_value,short_desc,section_id) values('DISPLAY_FEEDLIST_ACTIONS', 1, 'false', 'false', 'Display feedlist actions',2);
